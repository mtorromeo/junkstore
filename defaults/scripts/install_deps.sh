...
function install() {
    ...
    find ../../data/Junk-Store/scripts/Extensions -type f -name "install_deps.sh" -exec bash {} \;
...
function uninstall() {
    ...
    find ../../data/Junk-Store/scripts/Extensions -type f -name "install_deps.sh" -exec bash {} uninstall \;
